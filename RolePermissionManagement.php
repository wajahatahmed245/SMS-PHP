...
if (isset($_REQUEST["btnRolePermissionManagement"]))
{
    //echo '$_REQUEST["rolesRPM"] = '.$_REQUEST["rolesRPM"] ;
}
    ...
    <div class="container-fluid">
        <nav>
            ...
            <ul id="navbar" class="nav nav-tabs" style="font-size:19px;width:1600px;  height:52px;border: 0px;margin: 0px;">
                ...
                <li class="nav-item ">
                    <a class="nav-link active show" data-toggle="tab" href="RolePermissionManagement.php"><i class="fa fa-id-card-o"> </i>Role Permission Management</a>
                </li>
        ...
        <div class="row" style="margin-top:65px">
                ...
                <section>
                    ...
                    <div class="card border-#868e96 mb-3" style="max-width: 30rem; ">
                        ...
                        <div class="card-header" style="font-size:24px;color:#2FA4E7;">
                            <i class="fa fa-id-card-o"> </i> Role Permission Management </div>

                        <form action="RolePermissionManagement.php" method ="POST">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="rolesRPM" class="custom-select" id="Role" required>
                                ...
                                <div class="form-group">
                                    <label id="catchmeUsername" class="col-form-label" for="Permission">
                                        <strong>Permission:</strong>
                                    </label>

                                    <select name ="permissionRPM" class="custom-select" id="Permission" required>
                                        <option value= "" selected="">Open this select menu</option>
                                        <?php include 'permissionData.php'; ?>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" name="btnRolePermissionManagement" class="btn btn-primary" style="margin-left:260px;">save</button>
                            </div>
            ...
            <div class="col-8">
               <?php include 'RolePermissionManagementList.php'; ?>
            </div>
