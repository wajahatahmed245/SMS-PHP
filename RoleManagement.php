...
<body>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:65px">
            ...
            <div class="col-4" id="signin">
                <section>
                    ...
                    <div class="card border-#868e96 mb-3" style="max-width: 30rem; ">
                        ...
                        <form action="RoleManagement.php">
                            ...
                            <div id="header" class="card-body">
                                ...
                                <div class="form-group" id="parent">
                                    ...
                                    <input name="roleName" type="text" class="form-control" placeholder="Enter role name" id="adminUSername" required>
                                    <?php 
                                ...
                                <div class="form-group" id="parent">
                                    ...
                                    <input name="descripion" type="descripion" class="form-control" placeholder="Enter descripion" id="descripion" required>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" name="btnRoleManagement" class="btn btn-primary" style="margin-left:260px;">save</button>
                            </div>
            ...
            <div class="col-8">
               <?php include 'RoleManagementList.php'; ?>
            </div>
